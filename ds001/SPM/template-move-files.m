%-----------------------------------------------------------------------
% Job saved on 17-Aug-2016 14:21:53 by cfg_util (rev $Rev: 6460 $)
% spm SPM - SPM12 (6685)
% cfg_basicio BasicIO - Unknown
%-----------------------------------------------------------------------
matlabbatch{1}.cfg_basicio.file_dir.file_ops.file_move.files = {''};
matlabbatch{1}.cfg_basicio.file_dir.file_ops.file_move.action.copyto = {'/storage/essicd/data/NIDM-Ex/BIDS_Data/RESULTS/SOFTWARE_COMPARISON/ds001/SPM/PREPROCESSING/FUNCTIONAL'};
matlabbatch{2}.cfg_basicio.file_dir.file_ops.file_move.files = {''};
matlabbatch{2}.cfg_basicio.file_dir.file_ops.file_move.action.copyto = {'/storage/essicd/data/NIDM-Ex/BIDS_Data/RESULTS/SOFTWARE_COMPARISON/ds001/SPM/PREPROCESSING/FUNCTIONAL'};
matlabbatch{3}.cfg_basicio.file_dir.file_ops.file_move.files = {''};
matlabbatch{3}.cfg_basicio.file_dir.file_ops.file_move.action.copyto = {'/storage/essicd/data/NIDM-Ex/BIDS_Data/RESULTS/SOFTWARE_COMPARISON/ds001/SPM/PREPROCESSING/FUNCTIONAL'};
matlabbatch{4}.cfg_basicio.file_dir.file_ops.file_move.files = {''};
matlabbatch{4}.cfg_basicio.file_dir.file_ops.file_move.action.copyto = {'/storage/essicd/data/NIDM-Ex/BIDS_Data/RESULTS/SOFTWARE_COMPARISON/ds001/SPM/PREPROCESSING/ANATOMICAL'};
